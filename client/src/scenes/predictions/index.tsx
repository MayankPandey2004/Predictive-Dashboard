    ...
    <DashboardBox width="100%" height="100%" p="1rem" overflow="hidden">
        <FlexBetween m="1rem 2.5rem" gap="1rem">
            <Box>
                ...
                <Typography variant='h6'>Charted revenue and predicted revenue based on a single linear regression model.</Typography>
            </Box>
        ...
        <ResponsiveContainer width="100%" height="100%">
            ...
            >
                ...
                <XAxis dataKey="name" tickLine={false} style={{ fontSize: "10px" }} ><Label value="Month" offset={-5} position="insideBottom" /></XAxis>
                <YAxis domain={[12000, 26000]} axisLine={{ strokeWidth: '0' }} style={{ fontSize: "10px" }} tickFormatter={(v) => `$${v}`} ><Label value="Revenue in USD" angle={-90} offset={-5} position="insideLeft" /></YAxis>
                <Tooltip />
